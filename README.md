...
A Derail Valley mod that enhances the game's realism by implementing a dynamic fuel supply chain system:
...
- Fuel resupply mechanics requiring the use of dedicated fuel tanker wagons
...
After cloning the repository, some setup is required in order to successfully build the mod DLLs. You will need to create a new [Directory.Build.targets][references-url] file to specify your local reference paths. This file will be located in the main directory, next to FuelSupply.sln.
